...
12. To refine the capture, go to the Refine panel and select Enable Refinement. From there, you can proceed directly to the exporting process. Perform this refinement process for every capture from each sensor perspective. (You can refer to this [link](https://docs.depthkit.tv/docs/processing-studio-captures) for more information)
